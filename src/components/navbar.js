        ...
        >
          <ul className="navbar-nav float-right">
            <li className="nav-item dropdown">
              <button className="dropdown-menu-top-link text-dark dropdown-toggle" id="dropdownMenuLinkAbout" data-toggle="dropdown" aria-expanded="false">
                About
              </button>
            ...
            <li className="nav-item dropdown">
              <button className="dropdown-menu-top-link text-dark dropdown-toggle" id="dropdownMenuLinkForAuthors" data-toggle="dropdown" aria-expanded="false">
                For Authors
              </button>
              <div className="dropdown-menu">
