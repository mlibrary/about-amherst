      ...
      <div className="container">
        <div className="row">
          <div className="col-md-6">
            ...
            <small className="d-block"><a className="text-light" href="mailto:?info@?amherst.edu?">?info@amherst.edu?</a></small>
            <small className="d-block"><Link to="/internships" className="text-light">Internships</Link></small>
            <p className="social">
